export const CAPTION_KEYS = [
  ...
  {name: "Location", keyName: "Location", path: "display_metadata", inputType: "input"},
  {name: "Creator", keyName: "Creator", path: "display_metadata", inputType: "input"},
  {name: "Credit", keyName: "Credit", path: "display_metadata", inputType: "input"},
